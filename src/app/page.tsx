...
const testimonials = [
  ...
  },
  {
    ...
    fullQuote: "I have known this Place since 2004....last time I was here was +5yrs ago....Amazing Fresh food as always...It was great to catch up with My brother Mohamed .God sent Me there to hear and receive a special message from you my Brother...Alhamdulillah.",
    rating: 5
  },
  {
    name: "M. Thapelo",
    ...
    fullQuote: "Their portions are generous and the quality is consistent. I especially love their shawarmas and burgers. The fact that they're Halaal certified makes it even better.",
    rating: 5
  },
  {
    name: "Sarah K.",
    ...
    fullQuote: "You can taste the quality in every bite. Their fish is always fresh, and the batter is perfectly crispy. The chips are consistently good, and their sauces are amazing.",
    rating: 5
  },
  {
    name: "M. Sarah",
    ...
    fullQuote: "Some restaurants were hectic, like we were told to wait for an hour for an order. However, some restaurants were very quick..everything else was perfect.",
    rating: 5
  },
  {
    name: "M. Matona",
    ...
    fullQuote: "The Chip Shop is the best fast food place you can ever visit. Went there yesterday, because I saw the shop while browsing on TikTok so decided to try it out. Ordered fish and chips, the portions are good. The owner is very friendly, the shop is clean and the service was stellar, didn't even wait that long for the food. I'm definitely coming back to try other dishes on the menu.",
    rating: 5
  }
]
...
export default function Home() {
  ...
  const isInView1 = useInView(imageRef1, { once: true, amount: 0.5 })
  const isInView2 = useInView(imageRef2, { once: true, amount: 0.5 })
  const isAboutInView = useInView(aboutRef, { once: true, amount: 0.3 })
  const isFeaturedDishesInView = useInView(featuredDishesRef, { once: true, amount: 0.3 })
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-4xl">
            <motion.h1 
              className="text-[#ffd85c] text-3xl sm:text-4xl md:text-[50px] font-extrabold uppercase tracking-wider"
            ...
            <motion.p 
              className="mt-4 sm:mt-6 text-2xl sm:text-3xl md:text-[46px] font-bold uppercase tracking-tight text-white leading-normal sm:leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <span className="hover:bg-[var(--hover-bg)] hover:text-black w-full h-full flex items-center justify-center">View Our Menu</span>
              </Link>
            </motion.div>
          </div>
        </div>
      ...
      <section className="w-full relative overflow-hidden" aria-label="Featured images">
        <div className="flex flex-col sm:flex-row">
          <motion.div 
            ref={imageRef1}
            className="relative w-full h-[50vh] sm:h-screen bg-gray-200"
          ...
          >
            {imageError1 ? (
              <div className="absolute inset-0 flex items-center justify-center bg-gray-200 text-gray-500">
                <p>We&apos;re sorry, the image couldn&apos;t be loaded. Please try refreshing the page.</p>
              </div>
            ) : (
              <Image
          ...
          >
            {imageError2 ? (
              ...
              <Image
                src="/filler/board.jpg"
                alt="The Chip Shop menu board"
                fill
                sizes="(max-width: 640px) 100vw, 50vw"
                style={{ objectFit: 'cover' }}
                quality={100}
      ...
      >
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8">About The Chip Shop</h2>
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 mb-8 md:mb-0">
              <motion.div
                className="relative w-full aspect-square max-w-[300px] sm:max-w-[400px] mx-auto overflow-hidden rounded-lg shadow-lg"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: isAboutInView ? 1 : 0, scale: isAboutInView ? 1 : 0.8 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 to-red-600 p-2 rounded-lg">
            ...
            >
              <p className="text-base sm:text-lg mb-4">
                For 15 years, The Chip Shop has been serving up Ormonde&apos;s finest Halaal fish and chips. With a commitment to quality, freshness, and traditional flavors, we&apos;ve become a beloved local institution.
              </p>
              <p className="text-base sm:text-lg mb-4">
                Our hand-cut chips, crispy golden batter, and sustainably sourced fish are all crafted with care. Each meal is prepared to perfection using secret recipes that make every bite unforgettable.
              </p>
              <p className="text-base sm:text-lg mb-4">
                Located in Ormonde, we&apos;re proud to be one of the area&apos;s pioneering fast-food establishments, known for maintaining high standards of freshness and quality. Our Halaal certification and spotless kitchen reflect our dedication to excellence. Experience the best fish and chips in town—where every meal is made with passion and served with pride.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <motion.section 
        ...
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: isFeaturedDishesInView ? 1 : 0, y: isFeaturedDishesInView ? 0 : 50 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
      >
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12">Featured Dishes</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            {[
              { 
                name: "Fish & Chips", 
                description: "Our classic beer-battered fish served with crispy chips.",
                price: "From R75.00",
                image: "/featured/fish-n-chips.png", 
              },
              { 
                name: "Shawarma", 
                description: "Tender, spiced meat wrapped in a warm pita with fresh veggies.",
                price: "R105.00",
                image: "/featured/shawarma.png",
              },
              { 
                name: "Burger", 
                description: "Juicy beef patty with all the fixings on a toasted bun.",
                price: "From R105",
                image: "/featured/burger.png",
              },
              { 
                name: "Dagwood", 
                description: "Towering sandwich packed with various meats, cheeses, and veggies.",
                price: "From R120.00",
              ...
              <motion.div 
                key={index} 
                className="relative h-[300px] sm:h-[400px] overflow-hidden group"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: isFeaturedDishesInView ? 1 : 0, y: isFeaturedDishesInView ? 0 : 50 }}
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 text-white">
                  <h3 className="text-2xl sm:text-3xl font-bold mb-2">{item.name}</h3>
                  <p className="text-sm text-gray-200 mb-2 sm:mb-4 max-w-md">{item.description}</p>
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: isFeaturedDishesInView ? 1 : 0, y: isFeaturedDishesInView ? 0 : 20 }}
            transition={{ duration: 0.5, delay: 0.6 }}
          >
            <Link 
              href="/menu"
              className="bg-red-600 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg hover:bg-red-700 transition-colors duration-300 inline-flex items-center gap-2"
            >
              View Full Menu
      ...
      >
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-12">What Our Customers Say</h2>
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-sm text-white/80">{testimonials[currentTestimonial].source}</p>
              </div>
              <blockquote>
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                aria-label={isPlaying ? "Pause testimonial rotation" : "Play testimonial rotation"}
              >
      ...
      <motion.section
        ...
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: isUberEatsInView ? 1 : 0, y: isUberEatsInView ? 0 : 50 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
      >
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              <motion.h2 
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: isUberEatsInView ? 1 : 0, y: isUberEatsInView ? 0 : 20 }}
              ...
              <motion.p 
                ...
                transition={{ duration: 0.5, delay: 0.4 }}
              >
                Enjoy our delicious Halaal fish and chips, delivered right to your doorstep.
              </motion.p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 text-left">
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: isUberEatsInView ? 1 : 0, x: isUberEatsInView ? 0 : -20 }}
